...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("trajectory_name", default_value="whole_body_zoulu"),
            ...
            DeclareLaunchArgument("playback_speed", default_value="0.05"),
            DeclareLaunchArgument("csv_row_rate_hz", default_value="0.0"),
            DeclareLaunchArgument("enable_pre_positioning", default_value="true"),
            DeclareLaunchArgument("pre_position_duration_sec", default_value="15.0"),
            ...
            Node(
                ...
                name="dm_whole_body_trajectory_test_node",
                output="screen",
                parameters=[
                    {
